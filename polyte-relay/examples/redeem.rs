...
use polyte_relay::{BuilderAccount, BuilderConfig, RelayClient, WalletType};
use std::env;

#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    // Load .env from the root polyte directory
    from_path("/home/aidanb/Source/ABQT/polyte/.env").ok();
